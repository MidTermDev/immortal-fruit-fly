  ...
  return (
    <DocsShell current="/docs/roadmap/">
      ...
      <div className="phase done"><span className="k">done · live</span><h3>The registry and the collection</h3>
        <p><code>FlyRegistry</code>: an ERC-721 where each token is a fly with its connectome hash, brain state root, memory root, IPFS snapshot, energy, generation, deaths, parents and body. Mint for 1 $FLY, feed, resurrect, breed, assign to bodies; bodies accept, commit, log interactions and report deaths. Dead flies cannot be sold. At most 10,000. Fly #1 has already died in the arena, woken in DOOM and come back with matching hashes. <a href="/flies/">Mint one.</a></p></div>
