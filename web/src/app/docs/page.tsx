...
export default function Page() {
  return (
    <DocsShell current="/docs/">
      ...
      <div className="callout"><b>Live now.</b> The whole 139,248-neuron brain runs at real time and is anchored to <code>FlyWorld</code> at <code>{CFG.world}</code>; food is placed there by burning $FLY. The 155-neuron compass core is FlyBrain v2 at <code>{CFG.brain}</code>, ticked every two minutes by a keeper and by anyone who calls <code>tick()</code>. Everything below is verifiable on BscScan and reproducible from the <a href={CFG.links.github}>repository</a>.</div>
