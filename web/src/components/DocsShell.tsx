...
const NAV = [
  ...
  { h: "Where it goes", items: [["/docs/roadmap/", "Roadmap"], ["/docs/pebbles/", "Pebbles: the fly in hardware"], ["/docs/colony/", "The Colony: flies in Minecraft"], ["/docs/trend/", "The fly-brain trend"], ["/docs/science/", "Science & sources"]] },
];
